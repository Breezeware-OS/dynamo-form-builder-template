...
import net.breezeware.dynamo.forms.svc.entity.QFormInvitation;
...
import net.breezeware.dynamo.forms.webbff.dto.FormInvitationDto;
...
public class FormInvitationService {
    ...
    public List<String> retrieveUsersEmailForInvitation() {
        ...
        List<String> emailList = users.stream().map(UserDto::getEmail).collect(Collectors.toList());
