package net.breezeware.dynamo.forms.webbff.service;
...
import net.breezeware.dynamo.forms.svc.entity.FormVersion;
import net.breezeware.dynamo.forms.svc.entity.QForm;
import net.breezeware.dynamo.forms.svc.entity.QFormVersion;
import net.breezeware.dynamo.forms.svc.enumeration.FormAccessType;
import net.breezeware.dynamo.forms.svc.enumeration.FormStatus;
import net.breezeware.dynamo.forms.svc.service.FormInvitationSvcService;
import net.breezeware.dynamo.forms.svc.service.FormSvcService;
import net.breezeware.dynamo.forms.svc.service.FormVersionService;
import net.breezeware.dynamo.forms.webbff.dto.FormDto;
import net.breezeware.dynamo.forms.webbff.dto.FormVersionDto;
import net.breezeware.dynamo.forms.webbff.keycloak.dto.UserDto;
import net.breezeware.dynamo.forms.webbff.keycloak.service.KeycloakService;
import net.breezeware.dynamo.forms.webbff.mapper.MapperService;
...
public class FormBuilderService {
    ...
    private BooleanBuilder
        ...
        FormStatus formStatus = FormStatus.retrieveFormStatus(status).orElseThrow(
                () -> new DynamoException("Invalid status '%s' for form".formatted(status), HttpStatus.BAD_REQUEST));
        switch (formStatus) {
            case ARCHIVED:
            ...
            case ALL:
                ...
                break;
            default:
                throw new DynamoException("Invalid status '%s' for form".formatted(status), HttpStatus.BAD_REQUEST);
        }
    ...
    public FormDto retrieveForm(String uniqueId) {
        ...
        if (form.getAccessType().equalsIgnoreCase(FormAccessType.PRIVATE.getValue())) {
            ...
            // .orElseThrow(() -> new DynamoException("User not found in the system.",
            // HttpStatus.NOT_FOUND));
